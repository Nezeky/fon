...
pub trait Sink<Samp: Sample, const CH: usize>: Debug {
...
/// [`Sink`](crate::Sink).
#[derive(Debug)]
pub struct SinkTo<Samp, S, K, const CH: usize, const N: usize>
where
    Samp: Sample + From<S>,
    S: Sample,
    K: Sink<Samp, CH>,
...
impl<Samp, S, K, const CH: usize, const N: usize> SinkTo<Samp, S, K, CH, N>
where
    Samp: Sample + From<S>,
    S: Sample,
    K: Sink<Samp, CH>,
...
impl<Samp, S, K, const CH: usize, const N: usize> Sink<S, N>
    for &mut SinkTo<Samp, S, K, CH, N>
where
    Samp: Sample + From<S>,
    S: Sample,
    K: Sink<Samp, CH>,
